...
**Important!** The iframe should have camera and web-share access. Specify it in the `allow` attribute, and the browser will ask the user for permission to access the camera.
...
// camera and web-share access is required
...
|-----------------------| :---------------: | :---------------------: |--------------------------------------------------------------------------------------------------|
| `modelid`             | **+**<br />a list | **+**<br />a single value, **required** | The model identifiers for the models that should be displayed in the component.<br />The default for virtual try-on is to show all the models available in the fitting room. |
